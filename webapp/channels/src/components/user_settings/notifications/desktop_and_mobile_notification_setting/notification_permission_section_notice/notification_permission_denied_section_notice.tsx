        ...
        <div className='extraContentBeforeSettingList'>
            <SectionNotice
                ...
                text={intl.formatMessage({
                    ...
                    defaultMessage: 'You\'re missing important message and call notifications from ProTalk. To start receiving notifications, please enable notifications for ProTalk in your browser settings.',
                })}
                tertiaryButton={{
                    text: intl.formatMessage({
